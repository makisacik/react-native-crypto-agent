/** @format */
// TRAINING PAGE FOR DIFFIE-HELLMAN CONVERSATION AND A RELATED IMAGE
...
const ThirdLevelTraining3 = ({ onNext }: { onNext: () => void }) => {
    ...
    <View style={styles.container}>
      ...
      {showIcon && (
        <Animated.View style={[styles.iconContainer, animatedStyle]}>
          <Image
            source={require("../../../assets/secure_connection.png")}
            style={styles.icon}
          />
        </Animated.View>
      )}
...
export default ThirdLevelTraining3;
